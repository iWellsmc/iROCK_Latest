...
let files='<div><div><input type="file" name="file" class="qry-chos attachfile filesize"><span class="maxmp">(Max: 25MB)</span><br><span class="file-error-message"></span><button class="btn btn-clr add_file"><i class="fa fa-plus"></i></button></div></div>'
...
if(submit_val == '10'){
  addition_content+=`<table class="w-100"><tr><td>Settlement Amount %</td><td><input type='text' oninput="$(this).val(($(this).val().replace(/[^0-9]/g,'')))" class='percentage_val form-control' name='percentage_val'></td></tr></table>`
  $('.excp_content').html('')
